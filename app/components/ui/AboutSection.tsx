  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="w-full max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
        ...
        >
At Bakeats, every cup of chai finds its perfect partner in our golden-crisp rusks and freshly baked cookies crafted for warmth, comfort, and a delightful crunch that turns everyday tea breaks into sweet, memorable moments        </h1>
      </div>
    </div>
  );
}