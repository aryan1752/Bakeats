...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative min-h-[62vh] bg-white sm:min-h-[80vh] md:min-h-[100vh]">
      <div className="sticky top-0 h-[62vh] w-full overflow-hidden bg-white sm:h-[80vh] md:h-screen">

        {/* Video container — 90% width, centered */}
        <div
          className={`absolute inset-0 flex items-center justify-center transition-opacity duration-700 ${
            isTransitioning ? 'opacity-0' : 'opacity-100'
          }`}
        >
          <div className="relative h-full w-[90%] overflow-hidden mx-auto">
            <video
              ref={videoRef}
              ...
              className={`absolute left-1/2 top-1/2 z-0 w-full h-full -translate-x-1/2 -translate-y-1/2 object-cover transition-opacity duration-500 ${
            ...
            {!mediaLoaded && (
              <img
                ...
                className="absolute left-1/2 top-1/2 z-0 w-full h-full -translate-x-1/2 -translate-y-1/2 object-cover"
              />
            )}
          </div>
        </div>
        ...
        >
          ...
          <h1 className="font-serif text-[50px] leading-[0.92] font-semibold tracking-tight text-black md:text-[112px]">
            {headingBase}
            <br />
            COOKIE
          </h1>
...
>
  WhatsApp
        ...
        >
          <div className="font-serif text-[52px] leading-none font-semibold text-black md:text-[112px]">
        ...
        {/* Bottom social icons */}
        <div className="absolute bottom-2 left-1/2 z-20 flex -translate-x-1/2 items-center gap-4 text-black/60 sm:bottom-4 md:bottom-8 md:gap-5">
