...
const FALLBACK_COPY: Record<LangCode, CopyShape> = {
  ...
  es: {
    ...
    tagline2: "Muy popular y amado por los fans del crunch",
    heroMain: "",
    heroSub: "Clásico",
    heroOne: "Jeera",
    descLine1: "Nuestra galleta de jeera es crujiente, horneada y aromática —",
    descLine2: "¡destaca en cada lugar!",
  },

  ar: {
    tagline1: "قوي ولذيذ ومحبوب عند الجميع",
    tagline2: "الأكثر شعبية بين عشاق المقرمشات",
    heroMain: "",
    heroSub: "",
    heroOne: "جيرا",
    descLine1: "بسكويت الجيرا لدينا مقرمش ومخبوز بعناية —",
    descLine2: "طعمه المميز يظهر في كل مكان!",
  },

  "fr-CA": {
    tagline1: "Puissant, savoureux et aimé de tous",
    tagline2: "Très populaire chez les amateurs de croustillant",
    heroMain: "",
    heroSub: "Classique",
    heroOne: "Jeera",
    descLine1: "Notre biscuit au jeera est croustillant, cuit au four et aromatique —",
    descLine2: "il se démarque partout!",
  },

  de: {
    tagline1: "Kräftig, lecker und von allen geliebt",
    tagline2: "Sehr beliebt bei Crunch-Snack Fans",
    heroMain: "",
    heroSub: "Klassiker",
    heroOne: "Jeera",
    descLine1: "Unser Jeera-Keks ist knusprig, gebacken und aromatisch —",
    descLine2: "er überzeugt überall!",
  },

  "nl-BE": {
    tagline1: "Krachtig, lekker en ieders favoriet",
    tagline2: "Superpopulair bij crunchy snackfans",
    heroMain: "",
    heroSub: "Klassieker",
    heroOne: "Jeera",
    descLine1: "Onze jeera koek is knapperig, gebakken en aromatisch —",
    descLine2: "hij valt overal op!",
  },
};
