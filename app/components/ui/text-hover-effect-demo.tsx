...
export default function TextHoverEffectDemo() {
  return (
    <div className="flex min-h-[28rem] flex-col items-center justify-start pt-2 md:min-h-[40rem] md:pt-0">
      ...
      <p className="-mt-12 mb-4 w-[90%] bg-gradient-to-b from-blue-300 via-blue-400 to-blue-600 bg-clip-text text-center font-[cursive] text-[15px] leading-7 text-transparent drop-shadow-[0_1px_1px_rgba(59,130,246,0.35)] md:-mt-16 md:mb-12 md:w-[90%] md:text-xl md:leading-relaxed">
