...
export default function TextHoverEffectDemo() {
  return (
    <div className="flex min-h-[40rem] flex-col items-center justify-start pt-2 md:justify-center md:pt-0">
      ...
      <p className="-mt-20 mb-20 w-[80%] bg-gradient-to-b from-zinc-200 via-white to-zinc-500 bg-clip-text text-center font-[cursive] text-sm leading-relaxed text-transparent drop-shadow-[0_1px_1px_rgba(255,255,255,0.25)] md:-mt-24 md:mb-24 md:text-lg">
