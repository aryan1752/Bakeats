...
export default function TextHoverEffectDemo() {
  return (
    <div className="flex min-h-[28rem] flex-col items-center justify-start pt-2 md:min-h-[40rem] md:pt-0">
      ...
      <p className="mt-4 mb-4 w-[90%] bg-gradient-to-b from-zinc-200 via-white to-zinc-500 bg-clip-text text-center font-[cursive] text-[13px] leading-6 text-transparent drop-shadow-[0_1px_1px_rgba(255,255,255,0.25)] md:mt-12 md:mb-12 md:w-[80%] md:text-lg md:leading-relaxed">
